...
function EmptyState() {
  return (
    ...
    >
      ...
      <p className="text-lg font-light" style={{ color: '#41525d' }}>MeuZapDesk</p>
...
export function AtendimentoClient({
  ...
  // Keep ref in sync so SSE handler can access latest value without re-subscribing
  useEffect(() => {
    ...
    <div className="flex flex-col h-screen overflow-hidden" style={{ background: '#111b21' }}>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          {isOwner && (
            <Link href="/admin/users" className="text-xs hover:text-white transition" style={{ color: '#8696a0' }}>
              ⚙️ Admin
            </Link>
          )}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {loadingConv ? (
            <div className="flex items-center justify-center h-full" style={{ background: '#efeae2' }}>
